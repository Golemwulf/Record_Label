package record.label.controller.error;
...
public class GlobalControllerErrorHandler {
	...
	public ExceptionMessage handleDupicateKyException(DuplicateKeyException ex, WebRequest WebRequest) {
	...
	private ExceptionMessage buildExceptionMessage(Exception ex, HttpStatus status, WebRequest webRequest,
		...
		if (logStatus == LogStatus.MESSAGE_ONLY) {
			log.error("EWxception: {}", ex.toString());
		} else {
